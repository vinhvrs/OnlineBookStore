<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="OnlineBookstore.adminbookinventory" %>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="DropDownList2" runat="server">
                                        ...
                                        <asp:ListItem Text="Wiley" Value="Wiley" />
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col">
                                <div class="col">
                                    <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server"
                                        ...
                                        ControlStyle-Font-Bold="True" ItemStyle-Font-Bold="True">
                                        <Columns>
                                                   ...
                                                   <span>Language -<span>&nbsp;</span>
                                                       <asp:Label ID="Label4" runat="server" Font-Bold="True" Text='<%# Eval("language") %>'></asp:Label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        Publisher -
                                                   <asp:Label ID="Label5" runat="server" Font-Bold="True" Text='<%# Eval("publisher_id") %>'></asp:Label>
                                                                        &nbsp;| Publish Date -
